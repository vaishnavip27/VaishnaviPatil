        ...
        <div className="mx-auto w-full max-w-2xl space-y-8">
          ...
          <div className="flex-col flex flex-1 justify-center items-center space-y-1.5 instrument-serif-regular">
            ...
            >
              ...
              <span className="instrument-serif-regular main-text-in">{DATA.name.split(" ")[0]}</span>
            </BlurFade>
          </div>
        </div>
      </section>
          ...
          <BlurFade delay={BLUR_FADE_DELAY * 11}>
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              <div className="space-y-2">
                ...
                <h2 className="text-3xl font-black sm:text-5xl instrument-serif-regular">Recent Work</h2>
                <p className="text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                  I&apos;ve worked on a variety of projects, from{" "}
                  <b className="mr-1 dark:text-white text-black">frontend</b>
                  to <b className="dark:text-white text-black">backend</b> and even{" "}
                  <b className="dark:text-white text-black">smart contracts</b>. Here are a few of my favorites.
                </p>
              </div>
            </div>
          </BlurFade>
          ...
          <BlurFade delay={BLUR_FADE_DELAY * 11}>
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              <div className="space-y-2">
                ...
                <h2 className="text-3xl font-black tracking-tighter sm:text-5xl instrument-serif-regular py-2">My Journey</h2>
              </div>
            </div>
          </BlurFade>
          <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
            {[1, 2, 3, 4, 5, 6].map((i) => (
              <BlurFade key={`journey-${i}`} delay={BLUR_FADE_DELAY * 12 + i * 0.05}>
                <ProjectCard
                  href={`#journey-${i}`}
                  title={`Journey Step ${i}`}
                  description={`Write your paragraph here. This is item ${i} in your journey.`}
                  dates={`Date for Journey ${i}`}
                  tags={["Tag1", "Tag2"]}
                  image={`/placeholder.svg?height=300&width=400&text=Journey ${i}`}
                />
              </BlurFade>
            ))}
          </div>
